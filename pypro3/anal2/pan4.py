...
print(df_row)
df_col = df_row.unstack() # stack 결과를 원복
print(df_col)
...
print('pivot_table : pivot 과 groupby 기능을 모두 사용 가능---')
print(df)
...
print(df.pivot_table(values=['pop'], index='city', aggfunc=len)) # city별 pop의 건수

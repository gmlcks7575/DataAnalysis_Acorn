# Pandas : 고수준의 자료 구(Series, DataFrame)를 지원. 데이터 분석용 자료 관리를 위한 다양한 함수 제공
...
obj3 = Series(names)
print(obj3)
obj3.index=['마우스', '키보드', '모니터'] #인덱스명 변경
print(obj3)
print(obj3['마우스'])
obj3.name = '상품가격' #Series에 name을 붙힐 수 있다.
print(obj3)
...
#frame2.columns = ['juso','irum','nai','tel']
...
print(frame2.values) # 2차원 매트리스
print(frame2.values[0,1])
print(frame2.values[0:2])

print()
frame3 = frame2.drop('d') # 행삭제
...
print()
print(frame2)
print(frame2.sort_index(axis=0, ascending = False)) #False 내림차순 # 행 단위 
print(frame2.sort_index(axis=1, ascending = True)) #True 오름차순 #열 단위

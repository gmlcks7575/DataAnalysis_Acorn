# ROC(Receiver Operating Characteristic) curve는 다양한 threshold에 대한
...
recall = 44 / (44 + 4) # TP / TP + FN 재현율, 민감도
specificity = 44 / (44 + 8) # TN / FP + TN  특이도
fallout = 8 / (8 + 44) # FP / (FP + TN) 위양성률

print('acc(정확도):', acc)
print('recall(재현율, 민감도):', recall) # TPR : 전체 양성 샘플 중에서 양성으로 예측된 것의 비율
print('specificity(특이도):', specificity)
print('fallout(위양성률):', fallout) # FPR(1-특이도) : 전체 음성 생플 중에서 양성으로 잘못 예측된 것의 비율

...
print('\n--- 과적합 방지 목적 처리 3 ---')
# GridSearchCV : 교차검증과 최적의 속성(하이퍼 파라미터)을 위한 튠닝을 한 번에 처리
from sklearn.model_selection import GridSearchCV

# 여러 개의 속성 값 중 max_depth, min_samples_split에 대하여 최적의 값 찾기
parameters = {'max_depth':[1,2,3], 'min_samples_split':[2,3]}

grid_tree = GridSearchCV(dt_clf, param_grid = parameters, cv = 3, refit = True) #cv kfold수 refit은 재학습

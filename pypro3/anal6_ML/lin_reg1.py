...
# 종속변수(label, class)에 얼마나 영향을 주는지 인과관계를 분석
...
x, y, coef = make_regression(n_samples = 50, n_features = 1, bias = 100, coef = True) #coef 기울기출력
print(x)
print(y)
...
print(type(yy))
print('------------------')
# 모델 맛보기 2 : LinearRegression 을 사용. model 사용 O

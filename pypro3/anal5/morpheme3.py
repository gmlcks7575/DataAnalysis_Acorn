...
tag =count.most_common(100) #상위 50개만 작업에 참여
#print(tag)

import pytagcloud #워드크라우드 만들기
taglist = pytagcloud.make_tags(tag, maxsize = 100)
print('taglist:',taglist) # [{'color': (132, 120, 81), 'size': 105, 'tag': '마스크'}
...
#%matplotlib inline #jupyter에서 선언하면 show() 안해도 됌
